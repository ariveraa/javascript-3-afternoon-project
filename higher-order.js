...
//Code Here
let evenNumbers  = mixedNumbers.filter(num => num%2 === 0) // = mixedNumbers.filter(/* Provide Your Callback Here */)
...
//Code Here
let myStrongest  = monstersInYourPocket.filter(element => element.CP > 200) // = monstersInYourPocket.filter(/* Provide Your Callback Here */)
...
let orderTotals  = orders.map(element => element.price * (element.tax + 1)) // Code here
